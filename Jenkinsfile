   ...
   stages{
    ...
    stage('upload to nexus repository'){
      steps{
        ...
        nexusArtifactUploader artifacts: [[artifactId: 'artifact_id', classifier: '', file: 'target/vprofile-v1.war', type: 'war']], credentialsId: '8c09a263-d6a3-40bc-862e-9e0eb1ed0bf1', groupId: 'group_id', nexusUrl: 'http://13.127.128.64:8081/nexus', nexusVersion: 'nexus2', protocol: 'http', repository: 'EGA', version: '$BUILD_ID'
      }
    } 
     stage('ansible'){
       steps{
